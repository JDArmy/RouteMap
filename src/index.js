...
new Vue({
  ...
  data: {
    err: "123",
    aceEditorId: "aceEditorPane",
    routeMapId: "canvasPane",
    dotContent: `digraph LR{
  ...
  methods: {
    ...
    initAceEditor: function() {
      ...
      this.aceEditor.setValue(this.dotContent);
      beautify.beautify(this.aceEditor.getSession());
      this.aceEditor.getSession().on('change', () => {
        this.dotContent = this.aceEditor.getSession().getValue();
      })
    },
  },
  mounted() {
